    ...
    <header className="h-[10vh] sticky shadow-sm z-10 top-0 grid grid-cols-6 content-center justify-end py-5 bg-white px-10 backdrop-blur-3xl border-b">
      ...
      <nav className="col-span-5 ">
        ...
        <div className={`block md:hidden `}>
          ...
          <div className={`fixed h-screen   left-0 top-16  shadow-xl  border-t-2 w-[100%]  flex flex-col items-end  bg-black/20  overflow-hidden  delay-500 ${showNav ? "opacity-1 " : "opacity-0 "} duration-700`}  onClick={()=>setShowNav(false)}>
